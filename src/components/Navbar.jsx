  ...
  return (
    ...
    <div className='sidenav1'>
        ...
        <ul>
            ...
            <li><a href='/' id='project'><div className='text'> Projects</div><div className='icon'><FaBriefcase/></div></a></li>
            <li><a href='/' id='exp'><div className='text'> Experience</div><div className='icon'><FaBrain/></div></a></li>
            <li><a href='/' id='service'><div className='text'> Services</div><div className='icon'><FaServicestack/></div></a></li>
            <li><a href='/' id='contact'><div className='text'> Contact</div><div className='icon'><FaFileContract/></div></a></li>
        </ul>
    </div>
    </>
  )
